...
body 
  ...
  -restrocontainer
    - restro cards
      -image
      -name of restro,rating,cusines, delivery time, price
footer
  -address
  -links
...
const HeaderComponent = () => {
  return (
    <div className="header">
      <div className="logo">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDnaWzoMRv7165I-08OslKqXoqjtHR_2trY17fbjs&s" />
      </div>
